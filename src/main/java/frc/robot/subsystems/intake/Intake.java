...
public class Intake extends SubsystemBase {
  ...
  public Intake() {
    ...
    configs.Slot0.kP = 22.0; // An error of 0.5 rotations results in 1.2 volts output
    configs.Slot0.kD = 0.2; // A change of 1 rotation per second results in 0.1 volts output
